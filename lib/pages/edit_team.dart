...
class _EditTeamState extends State<EditTeam> {
  ...
  Widget _buildTeamDesc() {
    return Column(
        ...
        children: [
          Text(_teamName, style: Theme.of(context).textTheme.headlineMedium),
          Text(_teamDesc, style: Theme.of(context).textTheme.bodyMedium)
        ]);
  }
  ...
  Widget _buildTeamMembers() {
    return Column(
        ...
        children: [
          ...
          Column(children: [_buildMember(0), _buildMember(1), _buildMember(2)])
        ]);
  }
                ...
                child: Column(
                    ...
                    children: [
                      ...
                      Container(
                          padding: const EdgeInsets.fromLTRB(0, 5, 0, 5),
                          //height: screenHeight*0.05,
                          child: SolidButton(text: "EDIT TEAM NAME AND INFO")),
                      Container(
                          padding: const EdgeInsets.fromLTRB(0, 5, 0, 5),
                      ...
                      Container(
                          padding: const EdgeInsets.fromLTRB(0, 5, 0, 5),
                          //height: screenHeight*0.1,
                          child: SolidButton(text: "INVITE NEW MEMBER")),
                      _leaveTeamBtn()
                    ]))));
  }
}
