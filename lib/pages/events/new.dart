...
class EventSubmit extends StatefulWidget {
  @override
  _EventSubmitState createState() => _EventSubmitState();
}

class _EventSubmitState extends State<EventHome> {
  String _projName = "";
  String _projDesc = "";
  String _githubUrl = "";
  String _presUrl = "";
  ...
  Widget _buildPresentingLive() {
    ...
    return Container(
        ...
        child: Column(children: <Widget>[
          ...
          Text(
              'Do you wish to present live at the expo? If not, you must submit a video.',
